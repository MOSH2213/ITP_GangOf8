    ...
    <aside style="z-index: 99; max-width: 16.70rem !important;"
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Inventory" class="nav-link active" aria-controls="Inventory"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse" id="Inventory">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd2()" data-bs-toggle="tab" href="#InventoryList">
                                    <span class="sidenav-mini-icon"> P </span>
                                    <span class="sidenav-normal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd3()" data-bs-toggle="tab" href="#MachineList">
                                    <span class="sidenav-mini-icon"> P </span>
                                    <span class="sidenav-normal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd4()" data-bs-toggle="tab" href="#DamagedList">
                                    <span class="sidenav-mini-icon"> P </span>
                                    <span class="sidenav-normal">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Inventory Management
                        </li>
                    </ol>
        ...
        <div class="container-fluid p-0 p-md-4" style="overflow: hidden;">
            <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-12 mt-4 mt-lg-0">
                                    <div class="card z-index-2 ">
                                        <div class="card-header p-0 mt-2 mx-3 z-index-2 bg-transparent">
                ...
                <div class="tab-pane" id="DamagedList">
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-lg-flex">
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto">
                                                <a href="#" class="btn bg-gradient-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#AddDefects">+&nbsp; New
                                                    Product</a>
                                                <button type="button" class="btn btn-outline-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#Defectsimport"> Import
                                                </button>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-sm">
                                                        ...
                                                        <a href="javascript:;" class="mx-3" data-bs-toggle="modal"
                                                            data-bs-target="#defectsEditModal">
                                                            <i class="fas fa-user-edit text-secondary"></i>
                                                        </a>
                                                        <a href="javascript:;" data-bs-toggle="tooltip"
                                                            data-bs-original-title="Delete product">
                    ...
                    <!-- edit modal strarts here -->
                    <div class="modal fade" id="defectsEditModal" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0">
