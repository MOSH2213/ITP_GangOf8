    ...
    <aside style="z-index: 99; max-width: 16.70rem !important;"
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Employee" class="nav-link active"
                    ...
                    <div class="collapse " id="Employee">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " onclick="brd2()" data-bs-toggle="tab" href="#TraineeList">
                                    <span class="sidenav-mini-icon text-xs"> E </span>
                                    <span class="sidenav-normal"> Trainee </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " onclick="brd3()" data-bs-toggle="tab" href="#LeaveOverview">
                                    <span class="sidenav-mini-icon text-xs"> N </span>
                                    <span class="sidenav-normal"> Leave </span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " onclick="brd4()" data-bs-toggle="tab" href="#LeaveType">
                                    <span class="sidenav-mini-icon text-xs"> P </span>
                                    <span class="sidenav-normal"> Leave Type </span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " onclick="brd5()" data-bs-toggle="tab" href="#OverTime">
                                    <span class="sidenav-mini-icon text-xs"> O </span>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Employee Management
                        </li>
                    </ol>
            ...
            <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="card-body mt-3 p-0">
                                        <div class="chart">
                                            <canvas id="chart-line-widgets" class="chart-canvas" height="125"
                                            ...
                                            <div class="card ">
                                                ...
                                                <div class="card-body p-4 pb-0">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <p class="">Lorem, ipsum dolor.
                                                                        <br>fsdfsdfsfsfsdfsdfdf
                                                                    </p>
                                                                    <p class="mb-0">Email:</p>
                                                                    <p><a class="text-primary"
                                                                            href="#">example@gmail.com</a>
                                                                    </p>
                                                    ...
                                                    margin: auto;">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="input-group mb-0">
                                                                            <input class="form-control"
                                                                                ...
                                                                                placeholder="Press Generate" value=""
                                                                                disabled type="text">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <p class="text-xs mb-1">Press Generate to Suggext
                                                                    </p>
                                                    ...
                                                    <div class="row">
                                                                    ...
                                                                    <div class="col-4">
                                                                        <button
                                                                            ...
                                                                            <span class="btn-inner--icon"><i
                                                                                    class="ni ni-archive-2"></i></span>
                                                                            <span class="btn-inner--text">Export
                                                                                CSV</span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="row mt-0">
                                                                    <div class="col-12">
                                                                        <div class="w-90  mx-auto mb-2 rounded overflow-hidden"
                                                                            style="height: 150px;">
                                                                            <div>
                                                                                <p class="text-sm text-dark opacity-5">
                                                                                    Lorem
                                                                                    ipsum dolor sit
                                                                                    amet consectetur, adipisicing elit.
                                                                                    Magni
                                                                                    voluptates
                                                                                    voluptas, quis temporibus ipsa error
                                                                                    sit ab
                                                                                    dolorem
                                                                                    repudiandae harum molestias atque
                                                                                    sed itaque
                                                                                    ipsam
                                                                                    distinctio, quod fugiat, numquam
                                                                                    quibusdam.
                                                                                    Ipsa, rerum
                                                                                    ipsam nulla sapiente, commodi esse
                                                                                    velit
                                                                                    dolor ratione
                                                                                    voluptate iste voluptates iure ut
                                                                                    ipsum
                                                                                    temporibus sint eum
                                                                                    qui quibusdam aut id alias pariatur
                                                                                    tempore
                                                                                    vero. Molestias
                                                                                    hic quaerat sit blanditiis!
                                                                                    Repellat,
                                                                                    expedita soluta
                                                                                    recusandae ab commodi sapiente eius
                                                                                    architecto id vel earum
                                                                                    deserunt placeat corporis aliquam
                                                                                    explicabo
                                                                                    voluptate labore
                                                                                    dignissimos minima? Hic dicta,
                                                                                    perspiciatis
                                                                                    repellat nam
                                                                                    dolor quibusdam suscipit debitis
                                                                                    esse
                                                                                    sapiente provident
                                                                                    numquam ipsam quam quisquam sequi?
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="card ">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="table-responsive" id="tbl_exporttable_to_xls_2">
                                        ...
                                        <!-- modal of delivery starts -->
                                        <div class="modal fade " style="z-index: 99999;" id="modal-delivery"
                                    ...
                                    <div class="row">
                                        <div class="col-12 p-0">
                                            ...
                                            <div class="table-responsive p-0" id="tbl_exporttable_to_xls_3">
                                                <table class="table align-items-center mb-0" id="datatable-search3">
                                                    <thead>
                                                        <tr>
                                                            <th
                                                                class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                ...
                <div class="tab-pane" id="LeaveOverview">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <!-- modal of delivery starts -->
                            <div class="modal fade " style="z-index: 99999;" id="modal-leave" tabindex="-1"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-xs font-weight-bold p-0 pt-1">
                                                        <button class="btn btn-outline-dark btn-xs p-1 mb-0"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modal-leave">Deliever</button>
                                                    </td>
                ...
                <div class="tab-pane" id="LeaveType">
                    <div class="row">
                        <div class="col-12">
                            <!-- modal of delivery starts -->
                            <div class="modal fade " style="z-index: 99999;" id="modal-leavetype" tabindex="-1"
                                role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body p-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-xs font-weight-bold p-0 pt-1">
                                                        <button class="btn btn-outline-dark btn-xs p-1 mb-0"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modal-leavetype">Deliever</button>
                                                    </td>
                ...
                <div class="tab-pane" id="OverTime">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <!-- modal of delivery starts -->
                            <div class="modal fade " style="z-index: 99999;" id="modal-OverTime" tabindex="-1"
                                role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body p-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-xs font-weight-bold p-0 pt-1">
                                                        <button class="btn btn-outline-dark btn-xs p-1 mb-0"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modal-OverTime">Deliever</button>
                                                    </td>
