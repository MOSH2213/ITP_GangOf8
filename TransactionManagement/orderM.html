    ...
    <aside style="z-index: 99; max-width: 16.70rem !important;"
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Transaction" class="nav-link active"
                                ...
                                <div class="collapse " id="ordersExample">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item active">
                                            <a class="nav-link" data-bs-toggle="tab" href="#OrderOverview">
                                                <span class="sidenav-mini-icon text-xs"> O </span>
                                                <span class="sidenav-normal"> OverView</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " data-bs-toggle="tab" href="#OrderList">
                                                <span class="sidenav-mini-icon text-xs"> O </span>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Employee" class="nav-link" aria-controls="Employee"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse" id="Employee">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " data-bs-toggle="tab" href="../EmployeeManagement/EManage.html">
                                    <span class="sidenav-mini-icon text-xs"> O </span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-end">
                                            <button class="btn bg-gradient-dark mb-0" data-bs-toggle="modal"
                                                data-bs-target="#modal-form"><i class="fas fa-plus"
                                                    aria-hidden="true"></i>&nbsp;&nbsp;Add New Coupon</button>

                                        </div>

                                        <!-- modal starts -->
                                        <div class="modal fade " style="z-index: 99999;" id="modal-form" tabindex="-1"
                                                    ...
                                                    <div class="modal-body p-0">
                                                        <div class="card card-plain">
                                                            <div class="card-header pb-0 text-left">
                                                                <h4 class="font-weight-bolder  text-primary">Add Coupon
                                                                </h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-md-2 mb-4">
                                            <div
                                                ...
                                                <img class="w-20 me-3 mb-0" src="../assets/img/icons/COUPONS.gif"
                                                    alt="logo">
                                                <h7 class="mb-0">
                                                    Coupon Name
                                                </h7>
                                                ...
                                                <i class="fas fa-trash-alt ms-auto text-dark cursor-pointer"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" aria-hidden="true"
                                                    aria-label="Delete Card"></i><span class="sr-only">Edit Card</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-md-2 mb-4">
                                            <div
