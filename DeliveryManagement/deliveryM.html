  ...
  <aside style="z-index: 99; max-width: 16.70rem !important;"
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#Delivery" class="nav-link active" aria-controls="Delivery" role="button"
            aria-expanded="false">
            <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
          ...
          <div class="collapse" id="Delivery">
            <ul class="nav ms-4">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" onclick="brd1()" href="#deliveryOverview">
                  <span class="sidenav-mini-icon"> O </span>
                  <span class="sidenav-normal">OverView<b class="caret"></b></span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" onclick="brd2()" href="#driverList">
                  <span class="sidenav-mini-icon"> P </span>
                  <span class="sidenav-normal">
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" onclick="brd3()" href="#vehicleList">
                  <span class="sidenav-mini-icon"> P </span>
                  <span class="sidenav-normal">
