...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside style="z-index: 99; max-width: 16.70rem !important;"
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Customer" class="nav-link" aria-controls="Customer"
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Delivery" class="nav-link" aria-controls="Delivery"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Employee" class="nav-link" aria-controls="ecommerceExamples"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Supplier" class="nav-link" aria-controls="Supplier"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Inventory" class="nav-link" aria-controls="Inventory"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Branch" class="nav-link active" aria-controls="Branch"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse" id="Branch">
                        <ul class="nav ms-4">
                            <li class="nav-item">
                                <a class="nav-link active" onclick="brd1()" data-bs-toggle="tab"
                                    href="#payrollOverview">
                                    <span class="sidenav-mini-icon"> O </span>
                                    <span class="sidenav-normal">Overview<b class="caret"></b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd2()" data-bs-toggle="tab" href="#EmpSal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd3()" data-bs-toggle="tab" href="#StaffSal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd4()" data-bs-toggle="tab" href="#DeliverySal">
                                    <span class="sidenav-mini-icon"> M </span>
                                    <span class="sidenav-normal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd5()" data-bs-toggle="tab" href="#EmpPlayRoll">
                                    <span class="sidenav-mini-icon"> M </span>
                                    <span class="sidenav-normal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd6()" data-bs-toggle="tab" href="#StaffPlayRoll">
                                    <span class="sidenav-mini-icon"> M </span>
                                    <span class="sidenav-normal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd7()" data-bs-toggle="tab" href="#DeliveryPlayRoll">
                                    <span class="sidenav-mini-icon"> M </span>
                                    <span class="sidenav-normal">
    ...
    <main class="main-content position-relative border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Branch Management</li>
                    </ol>
        ...
        <div class="container-fluid p-0 p-md-4" style="overflow: hidden;">
            <div class="tab-content">
                <div class="tab-pane active" id="payrollOverview">
                    <div class="row mt-n2">
                        <div class=" col-12">
                            <div class="row">
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto">
                                                ...
                                                <button type="button" class="btn btn-outline-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#OverViewimportInventory">
                                                    Import
                                                </button>
                                                ...
                                                <div class="modal fade" id="OverViewimportInventory" tabindex="-1"
                                                    aria-hidden="true">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-check">
                                                                    ...
                                                                    <label class="custom-control-label"
                                                                        for="importCheck">I accept the terms and
                                                                        conditions</label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-sm">
                                                        ...
                                                        <a href="javascript:;" class="mx-3" data-bs-toggle="modal"
                                                            data-bs-target="#OverviewEditModal">
                    ...
                    <div class="modal fade" id="OverviewEditModal" tabindex="-1" role="dialog"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <label>Color</label>
                                                            <select class="form-control" name="choices-color"
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-lg-flex">
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto">
                                                <a href="#" class="btn bg-gradient-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#AddInventory">+&nbsp; New
                                                    Product</a>
                                                <button type="button" class="btn btn-outline-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#importInventory"> Import
                                                </button>
                ...
                <div class="tab-pane " id="StaffSal">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-lg-flex">
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto">
                                                <a href="#" class="btn bg-gradient-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#AddMachine">+&nbsp; New
                                                    Product</a>
                                                <button type="button" class="btn btn-outline-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#importMachine"> Import
                                                </button>
                    ...
                    <!-- edit modal strarts here -->
                    <div class="modal fade" id="MachineEditModal" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                ...
                <div class="tab-pane" id="DeliverySal">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-lg-flex">
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto">
                                                <a href="#" class="btn bg-gradient-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#Adddeleiverysal">+&nbsp; New
                                                    Product</a>
                                                <button type="button" class="btn btn-outline-primary btn-sm mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#importdeliverysal"> Import
                                                </button>
                    ...
                    <!-- edit modal strarts here -->
                    <div class="modal fade" id="DeiverySalEdit" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                ...
                <div class="tab-pane" id="EmpPlayRoll">
                    <div class="row mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 d-flex justify-content-start">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" onclick="brd5_1();">
                                    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        href="#emp-allowance" role="tab" aria-controls="pills-allowance"
                                        aria-selected="true">Allowance</a>
                                </li>
                                <li class="nav-item" onclick="brd5_2();">
                                    <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                        href="#emp-Deductions" role="tab" aria-controls="pills-Deductions"
                                        aria-selected="false">Deductions</a>
                                </li>
                                <li class="nav-item" onclick="brd5_3();">
                    ...
                    <div class="row">
                        <div class="col-12 mt-md-0 mt-0">
                            <div class="card">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="emp-allowance" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header pb-0">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    <a href="#"
                                                                        ...
                                                                        data-bs-target="#Allowance">+&nbsp; New
                                                                        Product</a>
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#Allowanceimport"> Import
                                                                    </button>
                                                                    ...
                                                                    <div class="modal fade" id="Allowanceimport"
                                                                        ...
                                                                        <div class="modal-dialog mt-lg-10">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <p>You can browse your computer for
                                                                                        a file.</p>
                                                                                    <input type="text"
                                                            ...
                                                            <table class="table" id="datatable-search5">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <img class="w-10 ms-3"
                                                                                    src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/ecommerce/living-chair.jpg"
                                                                                    alt="coco">
                                                                                <h6 class="ms-3 my-auto">Gray Living
                                                                                    Chair</h6>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-sm">Furniture</td>
                                                                        ...
                                                                        <td>
                                                                            <span
                                                                                class="badge badge-success badge-sm">in
                                                                                Stock</span>
                                                                        </td>
                                                                        <td class="text-sm">
                                                                            <a href="javascript:;"
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <img class="w-10 ms-3"
                                                                                    src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/ecommerce/orange-sofa.jpg"
                                                                                    alt="yohji">
                                                                                <h6 class="ms-3 my-auto">Derbyshire
                                                                                    Orange Sofa</h6>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-sm">Furniture</td>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <img class="w-10 ms-3"
                                                                                    src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/ecommerce/burberry.jpg"
                                                                                    alt="undercover">
                                                                                <h6 class="ms-3 my-auto">Burberry
                                                                                    Low-Tops</h6>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-sm">Shoes</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <img class="w-10 ms-3"
                                                                                    src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/ecommerce/d&g-skirt.jpg"
                                                                                    alt="D&G">
                                                                                <h6 class="ms-3 my-auto">Dolce & Gabbana
                                                                                    Skirt</h6>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-sm">Designer</td>
                                                                        ...
                                                                        <td>
                                                                            <span
                                                                                class="badge badge-danger badge-sm">Out
                                                                                of Stock</span>
                                                                        </td>
                                                                        <td class="text-sm">
                                                                            <a href="javascript:;"
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <img class="w-10 ms-3"
                                                                                    src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/ecommerce/undercover.jpg"
                                                                                    alt="undercover">
                                                                                <h6 class="ms-3 my-auto">Undercover
                                                                                    T-shirt</h6>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-sm">Shoes</td>
                                        ...
                                        <!-- edit modal strarts here -->
                                        <div class="modal fade" id="allowanceEdit" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="card h-100">
                                                                    <div class="card-body">
                                                                        <h5 class="font-weight-bolder">Product Image
                                                                        </h5>
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <img class="w-100 border-radius-lg shadow-lg mt-3"
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <div id="edit-deschiption-edit"
                                                                                    class="h-50"> Long sleeves
                                                                                    black
                                                                                    denim jacket with a twisted design.
                                                                                    Contrast stitching.
                                                                                    Button
                                                                                    up closure. White arrow prints on
                                                                                    the back. </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <label class="mt-4">Category</label>
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <option value="Choice 2">Real Estate
                                                                                    </option>
                                                                                    <option value="Choice 3">Electronics
                                                                                    </option>
                                                                                    <option value="Choice 4">Clothing
                                                                                    </option>
                                                                                    <option value="Choice 5">Others
                                                                                    </option>
                                                                                </select>
                                                                                <label>Color</label>
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <option value="Choice 2">White
                                                                                    </option>
                                                                                    <option value="Choice 3">Blue
                                                                                    </option>
                                                                                    <option value="Choice 4">Orange
                                                                                    </option>
                                                                                    <option value="Choice 5">Green
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-4">
                                                                                ...
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <option value="Choice 1"
                                                                                        selected="">USD</option>
                                                                                    <option value="Choice 2">EUR
                                                                                    </option>
                                                                                    <option value="Choice 3">GBP
                                                                                    </option>
                                                                                    <option value="Choice 4">CNY
                                                                                    </option>
                                                                                    <option value="Choice 5">INR
                                                                                    </option>
                                                                                    <option value="Choice 6">BTC
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-5">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                ...
                                                                                <select class="form-control"
                                                                                    name="choices-tags"
                                                                                    id="choices-tags-edit" multiple>
                                                                                    <option value="Choice 1" selected>In
                                                                                        Stock</option>
                                                                                    <option value="Choice 2">Out of
                                                                                        Stock</option>
                                                                                    <option value="Choice 3">Sale
                                                                                    </option>
                                                                                    <option value="Choice 4">Black
                                                                                        Friday</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="emp-Deductions" role="tabpanel">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    <a href="#"
                                                                        class="btn bg-gradient-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#AddDeductions">+&nbsp; New
                                                                        Product</a>
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#Deductionsimport"> Import
                                                                    </button>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-sm">
                                                                            ...
                                                                            <a href="javascript:;" class="mx-3"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#DeductionsEditModal">
                                                                                <i
                                                                                    class="fas fa-user-edit text-secondary"></i>
                                                                            </a>
                                                                            <a href="javascript:;"
                                        ...
                                        <!-- edit modal strarts here -->
                                        <div class="modal fade" id="DeductionsEditModal" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                                    ...
                                    <div class="tab-pane fade" id="emp-Overtime" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#empOvertimeimport"> Import
                                                                    </button>
                                                    ...
                                                    <div class="card-body px-0 pb-0">
                                                        <div class="table-responsive" id="tbl_exporttable_to_xls_7">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-sm">
                                                                            ...
                                                                            <a href="javascript:;" class="mx-3"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#empOvertimeEditModal">
                                                                                <i
                                                                                    class="fas fa-user-edit text-secondary"></i>
                                                                            </a>
                                                                            <a href="javascript:;"
                                        ...
                                        <!-- edit modal strarts here -->
                                        <div class="modal fade" id="empOvertimeEditModal" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                ...
                <div class="tab-pane" id="StaffPlayRoll">
                    <div class="row mb-4">
                        <div class="col-md-8 mt-md-0 mt-4">
                            <div class="card z-index-2">
                                <div class="card-header p-3 pb-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 d-flex justify-content-start">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" onclick="brd6_1();">
                                    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        href="#staff-allowance" role="tab" aria-controls="pills-allowance"
                                        aria-selected="true">Allowance</a>
                                </li>
                                <li class="nav-item" onclick="brd6_2();">
                                    <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                        href="#staff-Deductions" role="tab" aria-controls="pills-Deductions"
                                        aria-selected="false">Deductions</a>
                                </li>
                                <li class="nav-item" onclick="brd6_3();">
                                    <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                        href="#staff-Overtime" role="tab" aria-controls="pills-Overtime"
                                        aria-selected="false">Overtime</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 mt-md-0 mt-0">
                            <div class="card">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="staff-allowance" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header pb-0">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#StaffAllowanceimport"> Import
                                                                    </button>
                                                    ...
                                                    <div class="card-body px-0 pb-0">
                                                        <div class="table-responsive" id="tbl_exporttable_to_xls_8">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-sm">
                                                                            ...
                                                                            <a href="javascript:;" class="mx-3"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#StaffallowanceEdit">
                                                                                <i
                                                                                    class="fas fa-user-edit text-secondary"></i>
                                                                            </a>
                                                                            <a href="javascript:;"
                                        ...
                                        <!-- edit modal strarts here -->
                                        <div class="modal fade" id="StaffallowanceEdit" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                                    ...
                                    <div class="tab-pane fade" id="staff-Deductions" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#StuffDeductionsimport"> Import
                                                                    </button>
                                                    ...
                                                    <div class="card-body px-0 pb-0">
                                                        <div class="table-responsive" id="tbl_exporttable_to_xls_9">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-sm">
                                                                            ...
                                                                            <a href="javascript:;" class="mx-3"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#StaffDeductionsEditModal">
                                                                                <i
                                                                                    class="fas fa-user-edit text-secondary"></i>
                                                                            </a>
                                                                            <a href="javascript:;"
                                        ...
                                        <!-- edit modal strarts here -->
                                        <div class="modal fade" id="StaffDeductionsEditModal" tabindex="-1"
                                    ...
                                    <div class="tab-pane fade" id="staff-Overtime" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body px-0 pb-0">
                                                        <div class="table-responsive" id="tbl_exporttable_to_xls_10">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-sm">
                                                                            ...
                                                                            <a href="javascript:;" class="mx-3"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#StaffOvertimeEditModal">
                                                                                <i
                                                                                    class="fas fa-user-edit text-secondary"></i>
                                                                            </a>
                                                                            <a href="javascript:;"
                                        ...
                                        <!-- edit modal strarts here -->
                                        <div class="modal fade" id="StaffOvertimeEditModal" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                ...
                <div class="tab-pane" id="DeliveryPlayRoll">
                    <div class="row mb-4">
                        <div class="col-md-8 mt-md-0 mt-4">
                            <div class="card z-index-2">
                                <div class="card-header p-3 pb-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 d-flex justify-content-start">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" onclick="brd7_1();">
                                    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        href="#delievery-allowance" role="tab" aria-controls="pills-allowance"
                                        aria-selected="true">Allowance</a>
                                </li>
                                <li class="nav-item" onclick="brd7_2();">
                                    <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                        href="#delievery-Deductions" role="tab" aria-controls="pills-Deductions"
                                        aria-selected="false">Deductions</a>
                                </li>
                                <li class="nav-item" onclick="brd7_3();">
                                    <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                        href="#delievery-Overtime" role="tab" aria-controls="pills-Overtime"
                                        aria-selected="false">Overtime</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 mt-md-0 mt-0">
                            <div class="card">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="delievery-allowance" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header pb-0">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deliveryAllowanceimport"> Import
                                                                    </button>

                                                                    <!-- modal of add inventory starts -->
                                                                    <div class="modal fade" id="deliveryAllowance" tabindex="-1"
                                                                        aria-hidden="true">
                                                                        <div class="modal-dialog modal-lg mt-lg-10">
                                                                            <div class="modal-content">
                                                    ...
                                                    <div class="card-body px-0 pb-0">
                                                        <div class="table-responsive" id="tbl_exporttable_to_xls_11">
                                    ...
                                    <div class="tab-pane fade" id="delievery-Deductions" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    <a href="#"
                                                                        class="btn bg-gradient-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#AdddeliveryDeductions">+&nbsp; New
                                                                        Product</a>
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deliveryDeductionsimport"> Import
                                                                    </button>
                                                    ...
                                                    <div class="card-body px-0 pb-0">
                                                        <div class="table-responsive" id="tbl_exporttable_to_xls_12">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-sm">
                                                                            ...
                                                                            <a href="javascript:;" class="mx-3"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#deliveryDeductionsEditModal">
                                                                                <i
                                                                                    class="fas fa-user-edit text-secondary"></i>
                                                                            </a>
                                                                            <a href="javascript:;"
                                        ...
                                        <!-- edit modal strarts here -->
                                        <div class="modal fade" id="deliveryDeductionsEditModal" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                                    ...
                                    <div class="tab-pane fade" id="delievery-Overtime" role="tabpanel">
                                        <div class="row mt-0">
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header pb-0">
                                                            ...
                                                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                                                <div class="ms-auto my-auto">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm mb-0"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deleieveryOvertimeimport"> Import
                                                                    </button>
    ...
    <script>
        ...
        function brd5() {
            brd.innerHTML = "Employee PayRoll / Allowance";
        }
        function brd5_1() {
            brd.innerHTML = "Employee PayRoll / Allowance";
        }
        function brd5_2() {
            brd.innerHTML = "Employee PayRoll / Deduction";
        }
        function brd5_3() {
            brd.innerHTML = "Employee PayRoll / OverTime";
        }
        function brd6() {
            brd.innerHTML = "Staff PayRoll / Allowance";
        }
        function brd6_1() {
            brd.innerHTML = "Staff PayRoll / Allowance";
        }
        function brd6_2() {
            brd.innerHTML = "Staff PayRoll / Deduction";
        }
        function brd6_3() {
            brd.innerHTML = "Staff PayRoll / OverTime";
        }
        function brd7() {
            brd.innerHTML = "Delivery PayRoll / Allowance";
        }
        function brd7_1() {
            brd.innerHTML = "Delivery PayRoll / Allowance";
        }
        function brd7_2() {
            brd.innerHTML = "Delivery PayRoll / Deduction";
        }
        function brd7_3() {
            brd.innerHTML = "Delivery PayRoll / OverTime";
        }
