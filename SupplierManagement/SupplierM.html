    ...
    <aside style="z-index: 99; max-width: 16.70rem !important;"
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#Supplier" class="nav-link active" aria-controls="Supplier"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                        ...
                        <ul class="nav ms-4">
                            <li class="nav-item">
                                <a class="nav-link active" onclick="brd1()" data-bs-toggle="tab"
                                    href="#SupplierOverview">
                                    <span class="sidenav-mini-icon"> O </span>
                                    <span class="sidenav-normal">OverView<b class="caret"></b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd2()" data-bs-toggle="tab" href="#SorderList">
                                    <span class="sidenav-mini-icon"> O </span>
                                    <span class="sidenav-normal">Orders<b class="caret"></b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" onclick="brd3()" data-bs-toggle="tab" href="#SpaymentList">
                                    <span class="sidenav-mini-icon"> P </span>
                                    <span class="sidenav-normal">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" onclick="brd4()" href="#grnlist">
                                    <span class="sidenav-mini-icon text-xs"> E </span>
                                    <span class="sidenav-normal">Goods Received Note</span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <main class="main-content position-relative border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Supplier Management
                        </li>
                    </ol>
        ...
        <div class="container-fluid p-0 p-md-4" style="overflow: hidden;">
            <div class="tab-content">
                                        ...
                                        <div class="col-lg-4 col-12">
                                            <div class="card card-background card-background-mask-info h-100">
                                                <div class="full-background"
                                                    style="background-image: url('../../../assets/img/img-1-1200x1000.jpg')">
                                                </div>
                                                <div class="card-body pt-4 text-center">
                                                    <h6 class="text-white mb-0">Earnings</h6>
                                                    <h3 class="text-white">$15,800</h3>
                                                    <span class="badge d-block bg-gradient-dark mb-2">+15% since last
                                                        week</span>
                                                    <p>They're slowed down by their perception of themselves. </p>
                                                    <a href="javascript:;"
                                                        class="btn btn-outline-white btn-sm px-5 mb-0">View
                                                        more</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-12 mt-4 mt-lg-0">
                                            <div class="card">
                                                <div class="card-body p-3">
                                                    ...
                                                    <p class="mb-0">
                                                        <span
                                                            class="text-success text-sm font-weight-bolder">+12%</span>
                                                        since last month
                                                    </p>
                                                </div>
                                            </div>
                ...
                <div class="tab-pane" id="SorderList">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0">
                ...
                <div class="tab-pane " id="SpaymentList">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                ...
                                <div class="card-body p-3 position-relative">
                                    <div class="row">
                                        <div class="col-7 text-start">
                                            ...
                                            <span
                                                class="text-sm text-end text-success font-weight-bolder mt-auto mb-0">+55%
                                                <span class="font-weight-normal text-secondary">since last
                                                    month</span></span>
                                        </div>
                                        <div class="col-5">
                                            <div class="dropdown text-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end px-2 py-3"
                                                    ...
                                                    <li><a class="dropdown-item border-radius-md"
                                                            href="javascript:;">Last 7
                                                            days</a></li>
                                                    <li><a class="dropdown-item border-radius-md"
                                                            href="javascript:;">Last
                                                            week</a></li>
                                                    <li><a class="dropdown-item border-radius-md"
                                                            href="javascript:;">Last 30
                                                            days</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body p-3 position-relative">
                                    <div class="row">
                                        <div class="col-7 text-start">
                                            ...
                                            <span
                                                class="text-sm text-end text-success font-weight-bolder mt-auto mb-0">+12%
                                                <span class="font-weight-normal text-secondary">since last
                                                    month</span></span>
                                        </div>
                                        <div class="col-5">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-8 col-sm-6 mt-sm-0 mt-4">
                            <div class="card">
                                ...
                                <div class="card-body p-3">
                                    <canvas id="chart-line2" class="chart-canvas h-50"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
